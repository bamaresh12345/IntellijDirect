...
public class AddTwoNumbers {
    public static void main(String[] args) {
        ...
        System.out.println("The sum of " + number1 + " and " + num2 + " is: " + sum3);

        System.out.println("asdfsaThe sum of " + number1 + " and " + num2 + " is: " + sum1);
        System.out.println("asdfasfThe sum of " + number1 + " and " + num2 + " is: " + sum2);
        System.out.println("asdfasdfThe sum of " + number1 + " and " + num2 + " is: " + sum3);
